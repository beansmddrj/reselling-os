...
export type Database = {
  public: {
    Tables: {
      ...
      inventory_units: {
        Row: { id: string; owner_id: string; product_id: string; sku: string; status: Database["public"]["Enums"]["inventory_status"]; acquisition_cost_cents: number; acquired_at: string; storage_location: string | null; source_shipment_id: string | null; variant_size: string | null; is_stock_placeholder: boolean; created_at: string; updated_at: string };
        Insert: { id?: string; owner_id: string; product_id: string; sku: string; status?: Database["public"]["Enums"]["inventory_status"]; acquisition_cost_cents: number; acquired_at?: string; storage_location?: string | null; source_shipment_id?: string | null; variant_size?: string | null; is_stock_placeholder?: boolean; created_at?: string; updated_at?: string };
