...
function InventoryCard({ item }: { item: InventoryListItem }) {
  return (
    <Link href={`/inventory/${item.id}`} className="surface group overflow-hidden rounded-[1.7rem] transition hover:-translate-y-0.5 hover:border-white/15 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)] active:scale-[.99]">
